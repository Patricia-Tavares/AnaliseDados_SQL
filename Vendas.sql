...
/*  
1 - Apresente a query para listar o código e o nome do vendedor com maior número de vendas (contagem), 
...
select cdvdd as codigovendedor, nmvdd as nomevendedor
from tbvdd
where cdvdd is not null and nmvdd is not null
group by cdvdd,nmvdd
order by count (*) desc
-- o count tem que ser em cima da tabela de vendas
...
/* 
3 - Apresente a query para listar o código e nome cliente com maior gasto na loja. As colunas
