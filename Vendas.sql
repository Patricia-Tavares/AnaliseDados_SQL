...
select cdcli as codigocliente, nmcli as nomecliente, cdpro as codigoproduto, qtven as quantidadevendas
from tbven, tbven_item
where tbven.cdcli = tbven_item.cdpro  and qtven >= 6000
